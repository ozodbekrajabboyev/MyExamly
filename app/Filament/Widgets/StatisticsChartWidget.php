...
class StatisticsChartWidget extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        foreach ($exams as $exam) {
            ...
            // This logic now perfectly matches your table footer calculation.

            // 1. Get the average of the total scores obtained by students in this exam.
            // We round this to 2 decimal places to prevent floating point inaccuracies
            // and ensure it matches the likely precision of the table's calculation.
            $averageScore = round($marksForThisExam->avg('total_student_mark'), 1);

            // 2. Calculate the "Mastery Percentage" using this rounded average score.
